<?php require_once __DIR__ . '/../../app/helpers/auth.php'; requireAdmin(); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <p>Welcome, <?php echo $_SESSION['admin_name']; ?> | <a href="../../app/controllers/AuthController.php?logout=1">Logout</a></p>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(!empty($candidate['cv'])): ?>
                                    <a href="../../public/uploads/<?php echo basename($candidate['cv']); ?>" target="_blank">View CV</a>
                                <?php endif; ?>
                            </td>
                            <td>
                                <form action="../../app/controllers/CandidateController.php" method="POST" style="display:inline;">
